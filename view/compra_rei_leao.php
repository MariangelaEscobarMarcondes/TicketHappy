			...
			<table id="cart" class="table table-condensed">
					...
					<tbody>
						<tr class="tr_compra">
							<td data-th="Produto">
								<div class="row">
									<div class="col-sm-2 hidden-xs"><img src="imagens/aside/rei-leao.jpg" alt="..." class="img-responsive"/></div>
									<div class="col-sm-10">
						...
						<tr>
							...
							<td><div class="form-group">
								<label for="Total" class="col-sm-2 control-label color_label">Total:</label>
									<div class="col-sm-6">
										<input type="total" class="form-control" id="total">
									</div>
							</div></td>
							<td><a href="compra.html" class="btn btn-laranja btn-block">Comprar <i class="fa fa-angle-right"></i></a></td>
						</tr>
					</tfoot>
				</table>
		</main>
