	...
	<div id="wrapper">
		...
		<div id="content">
			...
			<div id="content_imagem_topo_principal">	
				<img src="imagens/topo/orquestra_e_danca.jpg" alt="Pesquisa" width="100%">		
			</div>	
			...
			<main>
			  ...
			  <div class="col-sm-6 col-md-4 ">
				<div class="thumbnail sombra">
				  <img src="imagens/4-orquestra_danca/ballet_boushoi_gisele/2.jpg" alt="foto do cartaz  do espetáculo de ballet Giselle" class="img-responsive">
				  <div class="caption">
					<h3>Giselle</h3>
			   ...
			   <div class="col-sm-6 col-md-4">
				<div class="thumbnail sombra">
				  <img src="imagens/4-orquestra_danca/quebra_nozes/1.jpg" alt="foto do cartaz do espetáculo de ballet O Quebra Nozes" class="img-responsive">
				  <div class="caption">
			  ...
			  <div class="col-sm-6 col-md-4">
				<div class="thumbnail sombra">
				  <img src="imagens/4-orquestra_danca/2.jpg" alt="foto do cartaz do espetáculo da Orquestra Sinfônica de Brasília" class="img-responsive">
				  <div class="caption">
			  ...
			  <div class="col-sm-6 col-md-4">
				<div class="thumbnail sombra">
				  <img src="imagens/4-orquestra_danca/1.jpg" alt="foto do cartaz do espetáculo da OSESP" class="img-responsive">
				  <div class="caption">
			   ...
			   <div class="col-sm-6 col-md-4">
				<div class="thumbnail sombra">
				  <img src="imagens/4-orquestra_danca/3.jpg" alt="foto do cartaz do espetáculo da Orquestra Sinfônica da UNICAMP" class="img-responsive">
				  <div class="caption">
