...
<div id="wrapper">
	...
	<div id="content">
		...
		<main id="largura_contato_form">	
			...
			<form action="/compra/inserir" method="POST" class="form-horizontal">
				
				<div class="form-group">
					<label for="nome" class="col-sm-2 control-label color_label">Nome</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" id="evento" name="nome" placeholder="Nome do Evento">
					</div>
				</div>
