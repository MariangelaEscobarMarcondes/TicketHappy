	...
	<div id="content">
		...
		<div id="content_imagem_topo_principal">	
			<img src="https://ticket-happy-mariangela.c9users.io/imagens/topo/Nacional.jpg" alt="Pesquisa" width="100%">		
		</div>
		...
		<div class="row">
			...
			<div class="col-sm-6 col-md-4">
				<div class="thumbnail sombra">
				  <img src="https://ticket-happy-mariangela.c9users.io/imagens/2-shows/Nacional/2.jpg" alt="foto do cartaz do show da banda Jota Quest" class="img-responsive">
				  <div class="caption">
					<h3>Jota Quest</h3>
					<p class="texto_centralizado">Teatro Guaíra</p>
					<p class="texto_centralizado">Curitiba – PR</p>
					<p>
						<a href="compra_jota_quest.html" class="btn btn-laranja" role="button"><span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span> Comprar</a> 
						<a href="jota_quest.html" class="btn btn-saiba-mais" role="button"><span class="glyphicon glyphicon-info-sign" aria-hidden="true"></span> Saiba +</a>
					</p>
				  </div>
				</div>
			</div>
		  ...
		  <div class="col-sm-6 col-md-4">
			<div class="thumbnail sombra">
			  <img src="https://ticket-happy-mariangela.c9users.io/imagens/2-shows/Nacional/1.jpg" alt="foto do cartaz do show da banda Skank" class="img-responsive">
			  <div class="caption">
				<h3>Skank</h3>				
				<p class="texto_centralizado">Palácio das Artes</p>
		   ...
		   <div class="col-sm-6 col-md-4">
			<div class="thumbnail sombra">
			  <img src="https://ticket-happy-mariangela.c9users.io/imagens/2-shows/Nacional/6.jpg" alt="foto do cartaz do show Los Infernais de Nando Reis" class="img-responsive">
			  <div class="caption">
				<h3>Nando Reis</h3>
				<p class="texto_centralizado">Mendes Convention Center</p>
				<p class="texto_centralizado">Santos - SP</p>				
				<p>
					<button type="button" class="btn btn-laranja" data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-shopping-cart"></span>  Comprar</button>
					<button type="button" class="btn btn-saiba-mais" data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-info-sign"></span>  Saiba +</button>
				</p>
		  ...
		  <div class="col-sm-6 col-md-4">
			<div class="thumbnail sombra">
			  <img src="https://ticket-happy-mariangela.c9users.io/imagens/2-shows/Nacional/5.jpg" alt="foto do cartaz do show de Fabio Jr" class="img-responsive">
			  <div class="caption">
				<h3>Fábio Júnior</h3>
				<p class="texto_centralizado">Teatro FAAP</p>
		   ...
		   <div class="col-sm-6 col-md-4">
			<div class="thumbnail sombra">
			  <img src="https://ticket-happy-mariangela.c9users.io/imagens/2-shows/Nacional/3.jpg" alt="foto do cartaz do  show de O Rappa" class="img-responsive">
			  <div class="caption">
				<h3>O Rappa</h3>
				<p class="texto_centralizado">Teatro SESC Pinheiros</p>
				<p class="texto_centralizado">São Paulo - SP</p>
				<p>
					<button type="button" class="btn btn-laranja" data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-shopping-cart"></span>  Comprar</button>
					<button type="button" class="btn btn-saiba-mais" data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-info-sign"></span>  Saiba +</button>
