...
<head>
	<meta charset="utf-8">
	<title>Ticket Happy - Shows / Nacional</title>
...
<div id="wrapper">
	...
	<div id="content">
		...
		<div id="content_imagem_topo_principal">	
			<img src="imagens/topo/Nacional.jpg" alt="Pesquisa" width="100%">		
		</div>
		...
		<div class="row">
			...
			<div class="col-sm-6 col-md-4">
				<div class="thumbnail sombra">
				  <img src="imagens/2-shows/Nacional/2.jpg" alt="foto do cartaz do show da banda Jota Quest" class="img-responsive">
				  <div class="caption">
					<h3>Jota Quest</h3>
		  ...
		  <div class="col-sm-6 col-md-4">
			<div class="thumbnail sombra">
			  <img src="imagens/2-shows/Nacional/1.jpg" alt="foto do cartaz do show da banda Skank" class="img-responsive">
			  <div class="caption">
				<h3>Skank</h3>				
		   ...
		   <div class="col-sm-6 col-md-4">
			<div class="thumbnail sombra">
			  <img src="imagens/2-shows/Nacional/6.jpg" alt="foto do cartaz do show Los Infernais de Nando Reis" class="img-responsive">
			  <div class="caption">
				<h3>Nando Reis</h3>
		  ...
		  <div class="col-sm-6 col-md-4">
			<div class="thumbnail sombra">
			  <img src="imagens/2-shows/Nacional/5.jpg" alt="foto do cartaz do show de Fabio Jr" class="img-responsive">
			  <div class="caption">
				<h3>Fábio Júnior</h3>
		   ...
		   <div class="col-sm-6 col-md-4">
			<div class="thumbnail sombra">
			  <img src="imagens/2-shows/Nacional/3.jpg" alt="foto do cartaz do  show de O Rappa" class="img-responsive">
			  <div class="caption">
				<h3>O Rappa</h3>
