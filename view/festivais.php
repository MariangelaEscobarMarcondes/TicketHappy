	...
	<div id="content">
		...
		<div id="content_imagem_topo" class="altura_imagem_topo">	
			<img src="https://ticket-happy-mariangela.c9users.io/imagens/topo/Festival.jpg" alt="Imagem de topo" width="100%">		
		</div>
		...
		<div class="row">
		  ...
		  <div class="col-sm-6 col-md-4">
			<div class="thumbnail sombra">
			  <img src="https://ticket-happy-mariangela.c9users.io/imagens/3-festivais/1.jpg" alt="foto do cartaz do festival Tomorrowland" class="img-responsive">
			  <div class="caption">
				<h3>Tomorrowland</h3>
				<p class="texto_centralizado">Arena Maeda</p>
				<p class="texto_centralizado">Itu  - SP</p>				
				<p>
		  ...
		  <div class="col-sm-6 col-md-4">
			<div class="thumbnail sombra">
			  <img src="https://ticket-happy-mariangela.c9users.io/imagens/3-festivais/2.jpg" alt="foto do cartaz do festival Rock in Rio" class="img-responsive">
			  <div class="caption">
				<h3>Rock in Rio</h3>
				<p class="texto_centralizado">Cidade do Rock</p>
		   ...
		   <div class="col-sm-6 col-md-4">
			<div class="thumbnail sombra">
			  <img src="https://ticket-happy-mariangela.c9users.io/imagens/3-festivais/3.jpg" alt="foto do cartaz do festival Lollapalooza Brasil" class="img-responsive">
			  <div class="caption">
				<h3>Lollapalooza Brasil</h3>
				<p class="texto_centralizado">Autódromo de Interlagos</p>
