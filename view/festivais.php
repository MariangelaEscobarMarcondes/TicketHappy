...
<head>
	<meta charset="utf-8">
	<title>Ticket Happy - Festivais</title>
...
<div id="wrapper">
	...
	<div id="content">
		...
		<div id="content_imagem_topo" class="altura_imagem_topo">	
			<img src="imagens/topo/Festival.jpg" alt="Pesquisa" width="100%">		
		</div>
		...
		<div class="row">
		  ...
		  <div class="col-sm-6 col-md-4">
			<div class="thumbnail sombra">
			  <img src="imagens/3-festivais/1.jpg" alt="foto do cartaz do festival Tomorrowland" class="img-responsive">
			  <div class="caption">
				<h3>Tomorrowland</h3>
		  ...
		  <div class="col-sm-6 col-md-4">
			<div class="thumbnail sombra">
			  <img src="imagens/3-festivais/2.jpg" alt="foto do cartaz do festival Rock in Rio" class="img-responsive">
			  <div class="caption">
				<h3>Rock in Rio</h3>
		   ...
		   <div class="col-sm-6 col-md-4">
			<div class="thumbnail sombra">
			  <img src="imagens/3-festivais/3.jpg" alt="foto do cartaz do festival Lollapalooza Brasil" class="img-responsive">
			  <div class="caption">
