...
<head>
	<meta charset="utf-8">
	<title>Ticket Happy - Contato</title>
		...
		<main id="largura_contato_form">
			...
			<form method="POST" action="/contato/inserir" class="form-horizontal">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
					  <input type="text" name="nome" id="nome" class="form-control" size="55" maxlength="50" placeholder="Nome Completo">
					</div>		
				</div>
				...
				<div class="form-group">
		  		...
		  		<div class="form-group">
					<label  class="col-sm-2 control-label color_label">Mensagem</label>
					<div class="col-sm-10">
