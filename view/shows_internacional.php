...
<head>
	<meta charset="utf-8">
	<title>Ticket Happy - Shows / Internacional</title>
...
<div id="wrapper">
	...
	<div id="content">
		...
		<div id="content_imagem_topo_principal">	
			<img src="imagens/topo/Internacional.jpg" alt="Pesquisa" width="100%">		
		</div>
		...
		<div class="row">		 
		  ...
		  <div class="col-sm-6 col-md-4">
			<div class="thumbnail sombra">
			  <img src="imagens/2-shows/Internacional/2.jpg" alt="foto do cartaz do show Coldplay" class="img-responsive">
			  <div class="caption">
				<h3>Coldplay</h3>
		   ...
		   <div class="col-sm-6 col-md-4">
			<div class="thumbnail sombra">
			  <img src="imagens/2-shows/Internacional/1.jpg" alt="foto do cartaz do show Elaiza" class="img-responsive">
			  <div class="caption">
				<h3>Elaiza</h3>
		   ...
		   <div class="col-sm-6 col-md-4">
			<div class="thumbnail sombra">
			  <img src="imagens/2-shows/Internacional/3.jpg" alt="foto do cartaz do show Julio Iglesias" class="img-responsive">
			  <div class="caption">
		  ...
		  <div class="col-sm-6 col-md-4">
			<div class="thumbnail sombra">
			  <img src="imagens/2-shows/Internacional/5.jpg" alt="foto do cartaz do show Ed Sheeran" class="img-responsive">
			  <div class="caption">
				<h3>Ed Sheeran</h3>
		   ...
		   <div class="col-sm-6 col-md-4">
			<div class="thumbnail sombra">
			  <img src="imagens/2-shows/Internacional/4.jpg" alt="foto do cartaz do show Maroon 5" class="img-responsive">
			  <div class="caption">
				<h3>Maroom 5</h3>
