		...
		<div id="content">
			...
			<div id="content_imagem_topo_principal">	
				<img src="https://ticket-happy-mariangela.c9users.io/imagens/topo/Comedia.jpg" alt="Pesquisa" width="100%">		
			</div>	
			...
			<main>
			  ...
			  <div class="col-sm-6 col-md-4 ">
				<div class="thumbnail sombra">
				  <img src="https://ticket-happy-mariangela.c9users.io/imagens/1-teatro/Comedia/a_ultima_secao/4.jpg" alt="foto do cartaz da peça A Última Sessão" class="img-responsive">
				  <div class="caption">
			  ...
			  <div class="col-sm-6 col-md-4">
				<div class="thumbnail sombra">
				  <img src="https://ticket-happy-mariangela.c9users.io/imagens/1-teatro/Comedia/elza_e_fred/3.jpg" alt="foto do cartaz da peça Elza e Fred" class="img-responsive">
				  <div class="caption">
					<h3>Elza e Fred</h3>
			   ...
			   <div class="col-sm-6 col-md-4">
				<div class="thumbnail sombra">
				  <img src="https://ticket-happy-mariangela.c9users.io/imagens/1-teatro/Comedia/nao_sou_bistro/1.jpg" alt="foto do cartaz da comédia Não sou Bistrô" class="img-responsive">
				  <div class="caption">
			  ...
			  <div class="col-sm-6 col-md-4">
				<div class="thumbnail sombra">
				  <img src="https://ticket-happy-mariangela.c9users.io/imagens/1-teatro/Comedia/to_gravida/6.jpg" alt="foto do cartaz da comédia Tô Grávida" class="img-responsive">
				  <div class="caption">
					<h3>Tô grávida</h3>
			  ...
			  <div class="col-sm-6 col-md-4">
				<div class="thumbnail sombra">
				  <img src="https://ticket-happy-mariangela.c9users.io/imagens/1-teatro/Comedia/trair_cocar_e_so_comecar/2.jpg" alt="foto do cartaz da comédia Trair e Coçar é só Começar" class="img-responsive">
				  <div class="caption">
			   ...
			   <div class="col-sm-6 col-md-4">
				<div class="thumbnail sombra">
				  <img src="https://ticket-happy-mariangela.c9users.io/imagens/1-teatro/Comedia/tres_entas/5.jpg" alt="foto do cartaz da comédia Três Entas" class="img-responsive">
				  <div class="caption">
					<h3>Três Entas</h3>
