...
<head>
	<meta charset="utf-8">
	<title>Ticket Happy - Teatro / Musical</title>
		...
		<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
		  ...
		  <!-- Wrapper for slides -->
			...
			<div class="item active">
			  <img src="imagens/topo/Musical.jpg" alt="..." class="img-responsive">		  
			</div>
		...
		<div class="row">
		  ...
		  <div class="col-sm-6 col-md-4">
			<div class="thumbnail sombra">
			  <img src="imagens/1-teatro/musical/2.jpg" alt="foto do cartaz do musical Mudança de Hábito" class="img-responsive">
			  <div class="caption">
		  ...
		  <div class="col-sm-6 col-md-4">
			<div class="thumbnail sombra">
			  <img src="imagens/1-teatro/musical/1.jpg" alt="foto do cartaz do espetáculo Chaplin – O Musical" class="img-responsive">
			  <div class="caption">
		   ...
		   <div class="col-sm-6 col-md-4">
			<div class="thumbnail sombra">
			  <img src="imagens/1-teatro/musical/3.jpg" alt="foto do cartaz do espetáculo As Noviças Rebeldes – O Musical" class="img-responsive">
			  <div class="caption">
		  ...
		  <div class="col-sm-6 col-md-4">
			<div class="thumbnail sombra">
			  <img src="imagens/1-teatro/musical/4.jpg" alt="foto do cartaz do musical O Rei Leão" class="img-responsive">
			  <div class="caption">
				<h3>O Rei Leão</h3>
				<p class="texto_centralizado">Teatro Renault</p>
				<p class="texto_centralizado">São Paulo - SP</p>
		  ...
		  <div class="col-sm-6 col-md-4">
			<div class="thumbnail sombra">
			  <img src="imagens/1-teatro/musical/5.jpg" alt="foto do cartaz da comédia musical A Família Addams" class="img-responsive">
			  <div class="caption">
		   ...
		   <div class="col-sm-6 col-md-4">
			<div class="thumbnail sombra">
			  <img src="imagens/1-teatro/musical/6.jpg" alt="foto do cartaz do espetáculo Cazuza – O Musical" class="img-responsive">
			  <div class="caption">
