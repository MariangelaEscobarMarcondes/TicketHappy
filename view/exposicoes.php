		...
		<div id="content">
			...
			<div id="content_imagem_topo" class="altura_imagem_topo">	
				<img src="https://ticket-happy-mariangela.c9users.io/imagens/topo/Exposicao.jpg" alt="Imagem de topo" width="100%">		
			</div>	
			...
			<main>
			  ...
			  <div class="col-sm-6 col-md-4">
				<div class="thumbnail sombra">
				  <img src="https://ticket-happy-mariangela.c9users.io/imagens/5-exposicoes/da_vinci/2.jpg" alt="foto do cartaz do evento Leonardo da Vinci – a exibição de um gênio" class="img-responsive">
				  <div class="caption">
					<h3>Da Vinci</h3>
					<p class="texto_centralizado">Shopping de Contagem</p>
			   ...
			   <div class="col-sm-6 col-md-4">
				<div class="thumbnail sombra">
				  <img src="https://ticket-happy-mariangela.c9users.io/imagens/5-exposicoes/human_bodies/3.jpg" alt="foto do cartaz da exposição internacional Human Bodies – maravilhas do corpo humano" class="img-responsive">
				  <div class="caption">
					<h3>Human Bodies</h3>
					<p class="texto_centralizado">Plaza Shopping Niterói</p>
					<p class="texto_centralizado">Niteroi -RJ</p>					
					<p>
						<button type="button" class="btn btn-laranja" data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-shopping-cart"></span>  Comprar</button>
						<button type="button" class="btn btn-saiba-mais" data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-info-sign"></span>  Saiba +</button>
					</p>
