...
<head>
	<meta charset="utf-8">
	<title>Ticket Happy - Exposições</title>
	...
	<div id="wrapper">
		...
		<div id="content">
			...
			<div id="content_imagem_topo" class="altura_imagem_topo">	
				<img src="imagens/topo/Exposicao.jpg" alt="Pesquisa" width="100%">		
			</div>	
			...
			<main>
			  ...
			  <div class="col-sm-6 col-md-4">
				<div class="thumbnail sombra">
				  <img src="imagens/5-exposicoes/da_vinci/2.jpg" alt="foto do cartaz do evento Leonardo da Vinci – a exibição de um gênio" class="img-responsive">
				  <div class="caption">
					<h3>Da Vinci</h3>
			   ...
			   <div class="col-sm-6 col-md-4">
				<div class="thumbnail sombra">
				  <img src="imagens/5-exposicoes/human_bodies/3.jpg" alt="foto do cartaz da exposição internacional Human Bodies – maravilhas do corpo humano" class="img-responsive">
				  <div class="caption">
					<h3>Human Bodies</h3>
